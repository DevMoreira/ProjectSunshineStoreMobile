...
public class Clothing_Shoes_4 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothing_shoes_4);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_clothing_shoes_4);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ic_back_page_clothing_shoes_4:
                valueButton = "back";
