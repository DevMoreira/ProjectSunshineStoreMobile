...
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Avengers_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Avengers_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Avengers_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Avengers_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Avengers_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Avengers_6;
...
public class AvengersPage extends AppCompatActivity implements View.OnClickListener {
    ...
    private View container_avengers_clothing_1, container_avengers_clothing_2, container_avengers_clothing_3,
            container_avengers_clothing_4, container_avengers_clothing_5, container_avengers_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avengers_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_avengers);
        ...
        container_avengers_clothing_1 = findViewById(R.id.avengers_clothing_1);
        container_avengers_clothing_2 = findViewById(R.id.avengers_clothing_2);
        container_avengers_clothing_3 = findViewById(R.id.avengers_clothing_3);
        container_avengers_clothing_4 = findViewById(R.id.avengers_clothing_4);
        container_avengers_clothing_5 = findViewById(R.id.avengers_clothing_5);
        container_avengers_clothing_6 = findViewById(R.id.avengers_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_avengers_clothing_1.setOnClickListener(this);
        container_avengers_clothing_2.setOnClickListener(this);
        container_avengers_clothing_3.setOnClickListener(this);
        container_avengers_clothing_4.setOnClickListener(this);
        container_avengers_clothing_5.setOnClickListener(this);
        container_avengers_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_avengers_1":
                Intent screenClothingAvengers1 = new Intent(this, Clothing_Avengers_1.class);
                startActivity(screenClothingAvengers1);
                break;
            case "clothing_avengers_2":
                Intent screenClothingAvengers2 = new Intent(this, Clothing_Avengers_2.class);
                startActivity(screenClothingAvengers2);
                break;
            case "clothing_avengers_3":
                Intent screenClothingAvengers3 = new Intent(this, Clothing_Avengers_3.class);
                startActivity(screenClothingAvengers3);
                break;
            case "clothing_avengers_4":
                Intent screenClothingAvengers4 = new Intent(this, Clothing_Avengers_4.class);
                startActivity(screenClothingAvengers4);
                break;
            case "clothing_avengers_5":
                Intent screenClothingAvengers5 = new Intent(this, Clothing_Avengers_5.class);
                startActivity(screenClothingAvengers5);
                break;
            case "clothing_avengers_6":
                Intent screenClothingAvengers6 = new Intent(this, Clothing_Avengers_6.class);
                startActivity(screenClothingAvengers6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ic_back_page_avengers:
                valueButton = "back";
            ...
            case R.id.avengers_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_avengers_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.avengers_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_avengers_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.avengers_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_avengers_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.avengers_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_avengers_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.avengers_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_avengers_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.avengers_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_avengers_6";
                changingScreen(valueButton);
                break;
        }
    }
