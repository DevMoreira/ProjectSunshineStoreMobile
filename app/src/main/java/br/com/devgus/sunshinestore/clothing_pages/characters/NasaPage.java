...
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Nasa_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Nasa_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Nasa_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Nasa_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Nasa_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Nasa_6;
...
public class NasaPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private View container_nasa_clothing_1, container_nasa_clothing_2, container_nasa_clothing_3,
            container_nasa_clothing_4, container_nasa_clothing_5, container_nasa_clothing_6;
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_nasa);
        ...
        container_nasa_clothing_1 = findViewById(R.id.nasa_clothing_1);
        container_nasa_clothing_2 = findViewById(R.id.nasa_clothing_2);
        container_nasa_clothing_3 = findViewById(R.id.nasa_clothing_3);
        container_nasa_clothing_4 = findViewById(R.id.nasa_clothing_4);
        container_nasa_clothing_5 = findViewById(R.id.nasa_clothing_5);
        container_nasa_clothing_6 = findViewById(R.id.nasa_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_nasa_clothing_1.setOnClickListener(this);
        container_nasa_clothing_2.setOnClickListener(this);
        container_nasa_clothing_3.setOnClickListener(this);
        container_nasa_clothing_4.setOnClickListener(this);
        container_nasa_clothing_5.setOnClickListener(this);
        container_nasa_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_nasa_1":
                Intent screenClothingNasa1 = new Intent(this, Clothing_Nasa_1.class);
                startActivity(screenClothingNasa1);
                break;
            case "clothing_nasa_2":
                Intent screenClothingNasa2 = new Intent(this, Clothing_Nasa_2.class);
                startActivity(screenClothingNasa2);
                break;
            case "clothing_nasa_3":
                Intent screenClothingNasa3 = new Intent(this, Clothing_Nasa_3.class);
                startActivity(screenClothingNasa3);
                break;
            case "clothing_nasa_4":
                Intent screenClothingNasa4 = new Intent(this, Clothing_Nasa_4.class);
                startActivity(screenClothingNasa4);
                break;
            case "clothing_nasa_5":
                Intent screenClothingNasa5 = new Intent(this, Clothing_Nasa_5.class);
                startActivity(screenClothingNasa5);
                break;
            case "clothing_nasa_6":
                Intent screenClothingNasa6 = new Intent(this, Clothing_Nasa_6.class);
                startActivity(screenClothingNasa6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.nasa_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_nasa_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.nasa_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_nasa_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.nasa_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_nasa_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.nasa_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_nasa_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.nasa_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_nasa_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.nasa_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_nasa_6";
                changingScreen(valueButton);
                break;
        }
    }
