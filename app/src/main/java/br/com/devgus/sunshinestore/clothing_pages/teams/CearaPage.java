...
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Ceara_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Ceara_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Ceara_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Ceara_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Ceara_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Ceara_6;
import br.com.devgus.sunshinestore.presentation_page.Presentation;

public class CearaPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private View container_ceara_clothing_1, container_ceara_clothing_2, container_ceara_clothing_3,
            container_ceara_clothing_4, container_ceara_clothing_5, container_ceara_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ceara_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_ceara);
        ...
        container_ceara_clothing_1 = findViewById(R.id.ceara_clothing_1);
        container_ceara_clothing_2 = findViewById(R.id.ceara_clothing_2);
        container_ceara_clothing_3 = findViewById(R.id.ceara_clothing_3);
        container_ceara_clothing_4 = findViewById(R.id.ceara_clothing_4);
        container_ceara_clothing_5 = findViewById(R.id.ceara_clothing_5);
        container_ceara_clothing_6 = findViewById(R.id.ceara_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_ceara_clothing_1.setOnClickListener(this);
        container_ceara_clothing_2.setOnClickListener(this);
        container_ceara_clothing_3.setOnClickListener(this);
        container_ceara_clothing_4.setOnClickListener(this);
        container_ceara_clothing_5.setOnClickListener(this);
        container_ceara_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_ceara_1":
                Intent screenClothingCeara1 = new Intent(this, Clothing_Ceara_1.class);
                startActivity(screenClothingCeara1);
                break;
            case "clothing_ceara_2":
                Intent screenClothingCeara2 = new Intent(this, Clothing_Ceara_2.class);
                startActivity(screenClothingCeara2);
                break;
            case "clothing_ceara_3":
                Intent screenClothingCeara3 = new Intent(this, Clothing_Ceara_3.class);
                startActivity(screenClothingCeara3);
                break;
            case "clothing_ceara_4":
                Intent screenClothingCeara4 = new Intent(this, Clothing_Ceara_4.class);
                startActivity(screenClothingCeara4);
                break;
            case "clothing_ceara_5":
                Intent screenClothingCeara5 = new Intent(this, Clothing_Ceara_5.class);
                startActivity(screenClothingCeara5);
                break;
            case "clothing_ceara_6":
                Intent screenClothingCeara6 = new Intent(this, Clothing_Ceara_6.class);
                startActivity(screenClothingCeara6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.ceara_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_ceara_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.ceara_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_ceara_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.ceara_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_ceara_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.ceara_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_ceara_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.ceara_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_ceara_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.ceara_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_ceara_6";
                changingScreen(valueButton);
                break;
        }
    }
