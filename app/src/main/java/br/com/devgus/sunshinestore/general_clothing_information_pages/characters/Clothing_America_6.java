...
public class Clothing_America_6 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothing_america_6);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_clothing_america_6);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ic_back_page_clothing_america_6:
                valueButton = "back";
