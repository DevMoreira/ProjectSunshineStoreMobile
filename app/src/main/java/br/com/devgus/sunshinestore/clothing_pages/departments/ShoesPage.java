...
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Shoes_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Shoes_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Shoes_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Shoes_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Shoes_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Shoes_6;
...
public class ShoesPage extends AppCompatActivity implements View.OnClickListener {
    ...
    private View container_shoes_clothing_1, container_shoes_clothing_2, container_shoes_clothing_3,
            container_shoes_clothing_4, container_shoes_clothing_5, container_shoes_clothing_6;
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_shoes);
        ...
        container_shoes_clothing_1 = findViewById(R.id.shoes_clothing_1);
        container_shoes_clothing_2 = findViewById(R.id.shoes_clothing_2);
        container_shoes_clothing_3 = findViewById(R.id.shoes_clothing_3);
        container_shoes_clothing_4 = findViewById(R.id.shoes_clothing_4);
        container_shoes_clothing_5 = findViewById(R.id.shoes_clothing_5);
        container_shoes_clothing_6 = findViewById(R.id.shoes_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_shoes_clothing_1.setOnClickListener(this);
        container_shoes_clothing_2.setOnClickListener(this);
        container_shoes_clothing_3.setOnClickListener(this);
        container_shoes_clothing_4.setOnClickListener(this);
        container_shoes_clothing_5.setOnClickListener(this);
        container_shoes_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_shoes_1":
                Intent screenClothingShoes1 = new Intent(this, Clothing_Shoes_1.class);
                startActivity(screenClothingShoes1);
                break;
            case "clothing_shoes_2":
                Intent screenClothingShoes2 = new Intent(this, Clothing_Shoes_2.class);
                startActivity(screenClothingShoes2);
                break;
            case "clothing_shoes_3":
                Intent screenClothingShoes3 = new Intent(this, Clothing_Shoes_3.class);
                startActivity(screenClothingShoes3);
                break;
            case "clothing_shoes_4":
                Intent screenClothingShoes4 = new Intent(this, Clothing_Shoes_4.class);
                startActivity(screenClothingShoes4);
                break;
            case "clothing_shoes_5":
                Intent screenClothingShoes5 = new Intent(this, Clothing_Shoes_5.class);
                startActivity(screenClothingShoes5);
                break;
            case "clothing_shoes_6":
                Intent screenClothingShoes6 = new Intent(this, Clothing_Shoes_6.class);
                startActivity(screenClothingShoes6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.shoes_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_shoes_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.shoes_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_shoes_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.shoes_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_shoes_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.shoes_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_shoes_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.shoes_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_shoes_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.shoes_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_shoes_6";
                changingScreen(valueButton);
                break;
        }
    }
