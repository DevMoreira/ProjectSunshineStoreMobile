...
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Pajamas_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Pajamas_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Pajamas_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Pajamas_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Pajamas_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Pajamas_6;
import br.com.devgus.sunshinestore.presentation_page.Presentation;

import static br.com.devgus.sunshinestore.R.id.ic_back_page_pajamas;
import static br.com.devgus.sunshinestore.R.id.ic_back_page_women;

public class PajamasPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private View container_pajamas_clothing_1, container_pajamas_clothing_2, container_pajamas_clothing_3,
            container_pajamas_clothing_4, container_pajamas_clothing_5, container_pajamas_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pajamas_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(ic_back_page_pajamas);
        ...
        container_pajamas_clothing_1 = findViewById(R.id.pajama_clothing_1);
        container_pajamas_clothing_2 = findViewById(R.id.pajama_clothing_2);
        container_pajamas_clothing_3 = findViewById(R.id.pajama_clothing_3);
        container_pajamas_clothing_4 = findViewById(R.id.pajama_clothing_4);
        container_pajamas_clothing_5 = findViewById(R.id.pajama_clothing_5);
        container_pajamas_clothing_6 = findViewById(R.id.pajama_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_pajamas_clothing_1.setOnClickListener(this);
        container_pajamas_clothing_2.setOnClickListener(this);
        container_pajamas_clothing_3.setOnClickListener(this);
        container_pajamas_clothing_4.setOnClickListener(this);
        container_pajamas_clothing_5.setOnClickListener(this);
        container_pajamas_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_pajama_1":
                Intent screenClothingPajamas1 = new Intent(this, Clothing_Pajamas_1.class);
                startActivity(screenClothingPajamas1);
                break;
            case "clothing_pajama_2":
                Intent screenClothingPajamas2 = new Intent(this, Clothing_Pajamas_2.class);
                startActivity(screenClothingPajamas2);
                break;
            case "clothing_pajama_3":
                Intent screenClothingPajamas3 = new Intent(this, Clothing_Pajamas_3.class);
                startActivity(screenClothingPajamas3);
                break;
            case "clothing_pajama_4":
                Intent screenClothingPajamas4 = new Intent(this, Clothing_Pajamas_4.class);
                startActivity(screenClothingPajamas4);
                break;
            case "clothing_pajama_5":
                Intent screenClothingPajamas5 = new Intent(this, Clothing_Pajamas_5.class);
                startActivity(screenClothingPajamas5);
                break;
            case "clothing_pajama_6":
                Intent screenClothingPajamas6 = new Intent(this, Clothing_Pajamas_6.class);
                startActivity(screenClothingPajamas6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ic_back_page_pajamas:
                valueButton = "back";
            ...
            case R.id.pajama_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_pajama_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.pajama_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_pajama_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.pajama_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_pajama_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.pajama_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_pajama_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.pajama_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_pajama_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.pajama_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_pajama_6";
                changingScreen(valueButton);
                break;
        }
    }
