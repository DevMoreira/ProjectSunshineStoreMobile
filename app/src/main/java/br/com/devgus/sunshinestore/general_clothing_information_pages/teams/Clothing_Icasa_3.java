...
public class Clothing_Icasa_3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clothing_icasa_3);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_clothing_icasa_3);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ic_back_page_clothing_icasa_3:
                valueButton = "back";
