...
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Icasa_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Icasa_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Icasa_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Icasa_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Icasa_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Icasa_6;
import br.com.devgus.sunshinestore.presentation_page.Presentation;

public class IcasaPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private View container_icasa_clothing_1, container_icasa_clothing_2, container_icasa_clothing_3,
            container_icasa_clothing_4, container_icasa_clothing_5, container_icasa_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icasa_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_icasa);
        ...
        container_icasa_clothing_1 = findViewById(R.id.icasa_clothing_1);
        container_icasa_clothing_2 = findViewById(R.id.icasa_clothing_2);
        container_icasa_clothing_3 = findViewById(R.id.icasa_clothing_3);
        container_icasa_clothing_4 = findViewById(R.id.icasa_clothing_4);
        container_icasa_clothing_5 = findViewById(R.id.icasa_clothing_5);
        container_icasa_clothing_6 = findViewById(R.id.icasa_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_icasa_clothing_1.setOnClickListener(this);
        container_icasa_clothing_2.setOnClickListener(this);
        container_icasa_clothing_3.setOnClickListener(this);
        container_icasa_clothing_4.setOnClickListener(this);
        container_icasa_clothing_5.setOnClickListener(this);
        container_icasa_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_icasa_1":
                Intent screenClothingIcasa1 = new Intent(this, Clothing_Icasa_1.class);
                startActivity(screenClothingIcasa1);
                break;
            case "clothing_icasa_2":
                Intent screenClothingIcasa2 = new Intent(this, Clothing_Icasa_2.class);
                startActivity(screenClothingIcasa2);
                break;
            case "clothing_icasa_3":
                Intent screenClothingIcasa3 = new Intent(this, Clothing_Icasa_3.class);
                startActivity(screenClothingIcasa3);
                break;
            case "clothing_icasa_4":
                Intent screenClothingIcasa4 = new Intent(this, Clothing_Icasa_4.class);
                startActivity(screenClothingIcasa4);
                break;
            case "clothing_icasa_5":
                Intent screenClothingIcasa5 = new Intent(this, Clothing_Icasa_5.class);
                startActivity(screenClothingIcasa5);
                break;
            case "clothing_icasa_6":
                Intent screenClothingIcasa6 = new Intent(this, Clothing_Icasa_6.class);
                startActivity(screenClothingIcasa6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.icasa_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_icasa_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.icasa_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_icasa_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.icasa_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_icasa_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.icasa_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_icasa_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.icasa_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_icasa_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.icasa_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_icasa_6";
                changingScreen(valueButton);
                break;
        }
    }
