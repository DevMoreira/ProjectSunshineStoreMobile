...
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Batman_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Batman_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Batman_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Batman_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Batman_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.characters.Clothing_Batman_6;
...
public class BatmanPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private View container_batman_clothing_1, container_batman_clothing_2, container_batman_clothing_3,
            container_batman_clothing_4, container_batman_clothing_5, container_batman_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batman_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_batman);
        ...
        container_batman_clothing_1 = findViewById(R.id.batman_clothing_1);
        container_batman_clothing_2 = findViewById(R.id.batman_clothing_2);
        container_batman_clothing_3 = findViewById(R.id.batman_clothing_3);
        container_batman_clothing_4 = findViewById(R.id.batman_clothing_4);
        container_batman_clothing_5 = findViewById(R.id.batman_clothing_5);
        container_batman_clothing_6 = findViewById(R.id.batman_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_batman_clothing_1.setOnClickListener(this);
        container_batman_clothing_2.setOnClickListener(this);
        container_batman_clothing_3.setOnClickListener(this);
        container_batman_clothing_4.setOnClickListener(this);
        container_batman_clothing_5.setOnClickListener(this);
        container_batman_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_batman_1":
                Intent screenClothingBatman1 = new Intent(this, Clothing_Batman_1.class);
                startActivity(screenClothingBatman1);
                break;
            case "clothing_batman_2":
                Intent screenClothingBatman2 = new Intent(this, Clothing_Batman_2.class);
                startActivity(screenClothingBatman2);
                break;
            case "clothing_batman_3":
                Intent screenClothingBatman3 = new Intent(this, Clothing_Batman_3.class);
                startActivity(screenClothingBatman3);
                break;
            case "clothing_batman_4":
                Intent screenClothingBatman4 = new Intent(this, Clothing_Batman_4.class);
                startActivity(screenClothingBatman4);
                break;
            case "clothing_batman_5":
                Intent screenClothingBatman5 = new Intent(this, Clothing_Batman_5.class);
                startActivity(screenClothingBatman5);
                break;
            case "clothing_batman_6":
                Intent screenClothingBatman6 = new Intent(this, Clothing_Batman_6.class);
                startActivity(screenClothingBatman6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.batman_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_batman_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.batman_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_batman_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.batman_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_batman_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.batman_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_batman_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.batman_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_batman_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.batman_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_batman_6";
                changingScreen(valueButton);
                break;
        }
    }
