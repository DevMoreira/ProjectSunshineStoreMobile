...
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Masculine_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Masculine_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Masculine_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Masculine_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Masculine_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Masculine_6;
import br.com.devgus.sunshinestore.presentation_page.Presentation;

public class MasculinePage extends AppCompatActivity implements View.OnClickListener{
    ...
    private View container_masculine_clothing_1, container_masculine_clothing_2, container_masculine_clothing_3,
            container_masculine_clothing_4, container_masculine_clothing_5, container_masculine_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_masculine_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_masculine);
        ...
        container_masculine_clothing_1 = findViewById(R.id.masculine_clothing_1);
        container_masculine_clothing_2 = findViewById(R.id.masculine_clothing_2);
        container_masculine_clothing_3 = findViewById(R.id.masculine_clothing_3);
        container_masculine_clothing_4 = findViewById(R.id.masculine_clothing_4);
        container_masculine_clothing_5 = findViewById(R.id.masculine_clothing_5);
        container_masculine_clothing_6 = findViewById(R.id.masculine_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_masculine_clothing_1.setOnClickListener(this);
        container_masculine_clothing_2.setOnClickListener(this);
        container_masculine_clothing_3.setOnClickListener(this);
        container_masculine_clothing_4.setOnClickListener(this);
        container_masculine_clothing_5.setOnClickListener(this);
        container_masculine_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_masculine_1":
                Intent screenClothingMasculine1 = new Intent(this, Clothing_Masculine_1.class);
                startActivity(screenClothingMasculine1);
                break;
            case "clothing_masculine_2":
                Intent screenClothingMasculine2 = new Intent(this, Clothing_Masculine_2.class);
                startActivity(screenClothingMasculine2);
                break;
            case "clothing_masculine_3":
                Intent screenClothingMasculine3 = new Intent(this, Clothing_Masculine_3.class);
                startActivity(screenClothingMasculine3);
                break;
            case "clothing_masculine_4":
                Intent screenClothingMasculine4 = new Intent(this, Clothing_Masculine_4.class);
                startActivity(screenClothingMasculine4);
                break;
            case "clothing_masculine_5":
                Intent screenClothingMasculine5 = new Intent(this, Clothing_Masculine_5.class);
                startActivity(screenClothingMasculine5);
                break;
            case "clothing_masculine_6":
                Intent screenClothingMasculine6 = new Intent(this, Clothing_Masculine_6.class);
                startActivity(screenClothingMasculine6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.ic_back_page_masculine:
                valueButton = "back";
            ...
            case R.id.masculine_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_masculine_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.masculine_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_masculine_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.masculine_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_masculine_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.masculine_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_masculine_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.masculine_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_masculine_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.masculine_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_masculine_6";
                changingScreen(valueButton);
                break;
        }
    }
