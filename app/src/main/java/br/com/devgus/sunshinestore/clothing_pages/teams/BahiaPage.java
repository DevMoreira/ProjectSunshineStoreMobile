...
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Bahia_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Bahia_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Bahia_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Bahia_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Bahia_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.teams.Clothing_Bahia_6;
import br.com.devgus.sunshinestore.presentation_page.Presentation;

public class BahiaPage extends AppCompatActivity implements View.OnClickListener{
    ...
    private View container_bahia_clothing_1, container_bahia_clothing_2, container_bahia_clothing_3,
            container_bahia_clothing_4, container_bahia_clothing_5, container_bahia_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bahia_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_bahia);
        ...
        container_bahia_clothing_1 = findViewById(R.id.bahia_clothing_1);
        container_bahia_clothing_2 = findViewById(R.id.bahia_clothing_2);
        container_bahia_clothing_3 = findViewById(R.id.bahia_clothing_3);
        container_bahia_clothing_4 = findViewById(R.id.bahia_clothing_4);
        container_bahia_clothing_5 = findViewById(R.id.bahia_clothing_5);
        container_bahia_clothing_6 = findViewById(R.id.bahia_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_bahia_clothing_1.setOnClickListener(this);
        container_bahia_clothing_2.setOnClickListener(this);
        container_bahia_clothing_3.setOnClickListener(this);
        container_bahia_clothing_4.setOnClickListener(this);
        container_bahia_clothing_5.setOnClickListener(this);
        container_bahia_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_bahia_1":
                Intent screenClothingBahia1 = new Intent(this, Clothing_Bahia_1.class);
                startActivity(screenClothingBahia1);
                break;
            case "clothing_bahia_2":
                Intent screenClothingBahia2 = new Intent(this, Clothing_Bahia_2.class);
                startActivity(screenClothingBahia2);
                break;
            case "clothing_bahia_3":
                Intent screenClothingBahia3 = new Intent(this, Clothing_Bahia_3.class);
                startActivity(screenClothingBahia3);
                break;
            case "clothing_bahia_4":
                Intent screenClothingBahia4 = new Intent(this, Clothing_Bahia_4.class);
                startActivity(screenClothingBahia4);
                break;
            case "clothing_bahia_5":
                Intent screenClothingBahia5 = new Intent(this, Clothing_Bahia_5.class);
                startActivity(screenClothingBahia5);
                break;
            case "clothing_bahia_6":
                Intent screenClothingBahia6 = new Intent(this, Clothing_Bahia_6.class);
                startActivity(screenClothingBahia6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.bahia_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_bahia_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.bahia_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_bahia_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.bahia_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_bahia_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.bahia_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_bahia_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.bahia_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_bahia_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.bahia_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_bahia_6";
                changingScreen(valueButton);
                break;
        }
    }
