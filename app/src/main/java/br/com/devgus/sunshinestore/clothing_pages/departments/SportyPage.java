...
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Sporty_1;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Sporty_2;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Sporty_3;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Sporty_4;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Sporty_5;
import br.com.devgus.sunshinestore.general_clothing_information_pages.departments.Clothing_Sporty_6;
import br.com.devgus.sunshinestore.presentation_page.Presentation;

public class SportyPage extends AppCompatActivity implements View.OnClickListener {
    ...
    private View container_sporty_clothing_1, container_sporty_clothing_2, container_sporty_clothing_3,
            container_sporty_clothing_4, container_sporty_clothing_5, container_sporty_clothing_6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sporty_page);
    ...
    public void loadingComponents(){
        ic_back = findViewById(R.id.ic_back_page_sporty);
        ...
        container_sporty_clothing_1 = findViewById(R.id.sporty_clothing_1);
        container_sporty_clothing_2 = findViewById(R.id.sporty_clothing_2);
        container_sporty_clothing_3 = findViewById(R.id.sporty_clothing_3);
        container_sporty_clothing_4 = findViewById(R.id.sporty_clothing_4);
        container_sporty_clothing_5 = findViewById(R.id.sporty_clothing_5);
        container_sporty_clothing_6 = findViewById(R.id.sporty_clothing_6);
    ...
    public void applyingContext(){
        ...
        container_sporty_clothing_1.setOnClickListener(this);
        container_sporty_clothing_2.setOnClickListener(this);
        container_sporty_clothing_3.setOnClickListener(this);
        container_sporty_clothing_4.setOnClickListener(this);
        container_sporty_clothing_5.setOnClickListener(this);
        container_sporty_clothing_6.setOnClickListener(this);
    ...
    public void changingScreen(String valueButton){
        switch (valueButton){
            case "back":
                ...
                break;
            case "clothing_sporty_1":
                Intent screenClothingSporty1 = new Intent(this, Clothing_Sporty_1.class);
                startActivity(screenClothingSporty1);
                break;
            case "clothing_sporty_2":
                Intent screenClothingSporty2 = new Intent(this, Clothing_Sporty_2.class);
                startActivity(screenClothingSporty2);
                break;
            case "clothing_sporty_3":
                Intent screenClothingSporty3 = new Intent(this, Clothing_Sporty_3.class);
                startActivity(screenClothingSporty3);
                break;
            case "clothing_sporty_4":
                Intent screenClothingSporty4 = new Intent(this, Clothing_Sporty_4.class);
                startActivity(screenClothingSporty4);
                break;
            case "clothing_sporty_5":
                Intent screenClothingSporty5 = new Intent(this, Clothing_Sporty_5.class);
                startActivity(screenClothingSporty5);
                break;
            case "clothing_sporty_6":
                Intent screenClothingSporty6 = new Intent(this, Clothing_Sporty_6.class);
                startActivity(screenClothingSporty6);
                break;
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.sporty_clothing_1:
            case R.id.info_clothing_1:
                valueButton = "clothing_sporty_1";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_2:
            case R.id.sporty_clothing_2:
            case R.id.info_clothing_2:
                valueButton = "clothing_sporty_2";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_3:
            case R.id.sporty_clothing_3:
            case R.id.info_clothing_3:
                valueButton = "clothing_sporty_3";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_4:
            case R.id.sporty_clothing_4:
            case R.id.info_clothing_4:
                valueButton = "clothing_sporty_4";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_5:
            case R.id.sporty_clothing_5:
            case R.id.info_clothing_5:
                valueButton = "clothing_sporty_5";
                changingScreen(valueButton);
                break;
            case R.id.img_clothing_6:
            case R.id.sporty_clothing_6:
            case R.id.info_clothing_6:
                valueButton = "clothing_sporty_6";
                changingScreen(valueButton);
                break;
        }
    }
